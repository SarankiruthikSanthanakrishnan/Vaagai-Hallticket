    ...
    <div class="card" id="main">
        ...
        <div class="card ">
            ...
            <!-- Image aligned to the left with bigger size -->
                <img src="vts logo.png" alt="Logo" style="width: 165px; height: auto;" class="img-fluid">

    <!-- Text aligned to the right center -->
                <div style="text-align: center; margin-left: auto;">
                    <h2 class="text-danger" style="font-weight: bolder;">வாகை தமிழ்ச்சங்கம்</h2><br>
            ...
            <div class=" text-light text-center" style="background-color: rgb(4, 23, 80);">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                        <div class="col" style="text-align: end;"> மதிப்பீட்டாளர் கையொப்பம் தேதியுடன்   <br><br><br></div>
                    </div>
                    </div>
                    <p class="text-center" style="margin:10px;"><u>அலுவலகப்பயன்பாட்டிற்கு மட்டும்</u></p>
                    <table id="oformat">
                        <tr id="oform">
    ...
    <!-- Text aligned to the right center -->
            ...
            <div class="card-body">
                ...
                <div class="row">
                        ...
                        <div class="col" style="text-align: end;"> தேர்வரின் கையொப்பம் <br><br></div>
                    </div>
                <br><br>
                <div class="row">
                    <div class="col-6 text-center">பொறுப்பாளர்</div>
    ...
    <div class="card" id="main">
        <div class="card-body">
            <div class="bg-primary" style="width:100%">
                <img src="form5.jpg" width="100%" height="100%">
            </div>
...
<div class="page-7">
    <div class="card" id="main">
        <div class="card-body">
            <div class="bg-primary" style="width:100%">
                <img src="form6.jpg" width="100%" height="100%">
            </div>
...
<div class="print-button">
    ...
    <footer textAlign-center>Copyright © VAAGAI TAMILSANGAM | NAMMAKKAL | vaagaitamilsangam@gmaill.com | </footer> 
</div>
</body>
</html>
